...
class dox_OptionsWindow(object):
    @classmethod
    def showUI(cls):
        win = cls()
        win.create()
    ...
    def commonMenu(self):
        ...
        self.editMenuSave = cmds.menuItem(label='Save Settings', command=self.editMenuResetCmd)
        ...
        self.editMenuTool = cmds.menuItem(label='As Tool', radioButton=True, enable=self.supportsToolAction, command=self.editMenuToolCmd)
        self.editMenuAction = cmds.menuItem(label = 'As Action', radioButton=True, enable=self.supportsToolAction, command=self.editMenuActionCmd)
